 ...
 * @param {Object} options 基本配置 { pageSize: 10, total: 62, current: 20 }
 * @param {Function} onPageChangeCallback 页码变化回调（通知主程序页码变化）
 */
...
Paginator.prototype.renderPagers = function () {
    ...
    if (
        ...
        render([1, 5], [], [this.options.total - 4, this.options.total]);
    }
